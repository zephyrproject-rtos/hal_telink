...
#define MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED        // EXPERIMENTAL
// #endif
...
// #if defined(CONFIG_MBEDTLS_ECDSA_DETERMINISTIC)      // EXPERIMENTAL 
#define MBEDTLS_ECDSA_DETERMINISTIC
// #endif

// #if defined(CONFIG_MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED)
#define MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED           // EXPERIMENTAL
// #endif
...
#define MBEDTLS_CCM_C  // 6 tests, 20.6 sec
// #endif

// #if defined(CONFIG_MBEDTLS_CIPHER_GCM_ENABLED)
#define MBEDTLS_GCM_C
#define MBEDTLS_CIPHER_C  // 5 tests work at this point, 20sec
// #endif

// #if defined(CONFIG_MBEDTLS_CIPHER_MODE_XTS_ENABLED)
#define MBEDTLS_CIPHER_MODE_XTS  // 6 tests, 20.743 sec
// #endif

// #if defined(CONFIG_MBEDTLS_CIPHER_MODE_CBC_ENABLED)
#define MBEDTLS_CIPHER_MODE_CBC  // 6 tests, 41.888 sec
// #endif

// #if defined(CONFIG_MBEDTLS_CIPHER_MODE_CTR_ENABLED)
#define MBEDTLS_CIPHER_MODE_CTR  // 6 tests, 41.887 sec
// #endif

/* Supported elliptic curves */

// #if defined(CONFIG_MBEDTLS_ECP_DP_SECP192R1_ENABLED)
#define MBEDTLS_ECP_DP_SECP192R1_ENABLED  // 6 tests, 41.901 sec
// #endif
...
// module for MBEDTLS_AES_C usage
#define MBEDTLS_CTR_DRBG_C  // 7 tests, 41.7 sec
// #endif

// #if defined(CONFIG_MBEDTLS_HMAC_DRBG_ENABLED)
#define MBEDTLS_HMAC_DRBG_C // 12 tests, 43.1 sec
// #endif
...
#define MBEDTLS_ERROR_STRERROR_DUMMY            // EXPERIMENTAL
...
#define MBEDTLS_CIPHER_C  // already done
#endif

// #if defined(CONFIG_MBEDTLS_MD)
#define MBEDTLS_MD_C  // 10 test, 43,78 sec
// #endif
...
#define MBEDTLS_BASE64_C  // 7 test
// #endif

// #if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED)
#define MBEDTLS_ECDSA_Cf
// #endif

// #if defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED)
#define MBEDTLS_ECJPAKE_C   // 14 tests 49.9 sec
// #endif
...
#define MBEDTLS_ECP_C       // 13 tests, 48.5 sec
// #endif
/*
 ECP alternative
*/
